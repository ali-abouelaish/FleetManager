-- ====================================================
-- Remove auto-resolve logic from certificate notifications
-- ====================================================
-- This migration removes the automatic resolution of notifications
-- Notifications should only be resolved manually by admins or when documents are uploaded
-- ====================================================
...
COMMENT ON FUNCTION create_certificate_notifications() IS 'Creates notifications for expiring compliance certificates (vehicles, drivers, passenger assistants). Should be run daily via cron or manually via the refresh button. Notifications are NOT auto-resolved - they must be manually resolved by admins.';
